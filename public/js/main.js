    ...
    $.post(`${actionUrl}`, comment, function (data) {
      ...
      <div class="media-content">
        ...
        <nav class="level is-mobile">
          ...
          <form action="/stories/${data[0].storyId}/comments/${
      data[0].commentId
    }" method="POST" id="editCommentForm">
            <div class="field">
              <p class="control">
              <textarea class="textarea" rows="2" name="editedComment">${
                data[0].comment
              }</textarea>
              </p>
            </div>
      ...
      <div class="card">
        <div class="card-image">
          <figure class="image is-4by3">
            <img src="${data.image ? data.image : 'https://bulma.io/images/placeholders/1280x960.png'}" alt="Story Image">
          </figure>
        </div>
